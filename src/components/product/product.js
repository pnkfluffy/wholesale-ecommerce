...
class Product extends React.Component {
  ...
  componentDidMount () {
    ...
    const product = products.find(
      product => product._id === this.props.match.params.productID
    )
    ...
    if (order && order.products.length) {
      const productInOrder = order.products.find(
        product => product.product === this.props.match.params.productID
      )
      if (productInOrder) quantity = productInOrder.quantity
    }
    this.setState({
      product: product,
      quantity: quantity
